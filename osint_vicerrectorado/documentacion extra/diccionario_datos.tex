...
\bottomrule
\caption{Tabla \texttt{fuente\_osint} — Fuentes OSINT (3 registros)}
\end{longtable}
...
\bottomrule
\caption{Tabla \texttt{dato\_recolectado} — Datos crudos (54 registros)}
\end{longtable}
...
\bottomrule
\caption{Tabla \texttt{comentario} — Comentarios (61 registros)}
\end{longtable}
...
\bottomrule
\caption{Tabla \texttt{dato\_procesado} — Datos procesados (49 registros)}
\end{longtable}
...
\bottomrule
\caption{Tabla \texttt{analisis\_sentimiento} — Sentimientos (69 registros)}
\end{longtable}
...
fecha\_analisis & TIMESTAMP & & & & Fecha del análisis. \\
\bottomrule
\caption{Tabla \texttt{analisis\_comentario} — Sentimiento de comentarios (57 registros)}
\end{longtable}
...
\bottomrule
\caption{Tabla \texttt{clasificacion\_tematica} — Clasificación temática (53 registros)}
\end{longtable}
...
fecha\_analisis & TIMESTAMP & & & & Fecha del análisis. \\
\bottomrule
\caption{Tabla \texttt{nlp\_clusters} — Clusters K-Means (6 registros)}
\end{longtable}
...
fecha\_analisis & TIMESTAMP & & & & Fecha del análisis. \\
\bottomrule
\caption{Tabla \texttt{nlp\_entidades} — Entidades NER (15 registros)}
\end{longtable}
...
\bottomrule
\caption{Tabla \texttt{osint\_noticias} — Noticias (40 registros)}
\end{longtable}
...
\bottomrule
\caption{Tabla \texttt{osint\_tendencias} — Tendencias (24 registros)}
\end{longtable}
...
metadata\_json & TEXT & & & & Metadatos JSON. \\
\bottomrule
\caption{Tabla \texttt{osint\_fuente\_resumen} — Resumen de fuentes OSINT (4 registros)}
\end{longtable}
...
\bottomrule
\caption{Tabla \texttt{usuario} — Usuarios del sistema (4 registros)}
\end{longtable}
...
\bottomrule
\caption{Tabla \texttt{log\_actividad} — Logs de actividad (7 registros)}
\end{longtable}
...
\bottomrule
\caption{Tabla \texttt{alerta} — Alertas (9 registros)}
\end{longtable}
...
\bottomrule
\caption{Tabla \texttt{log\_ejecucion} — Logs de ejecución (28 registros)}
\end{longtable}
...
\midrule
fuente\_osint & 3 & Recolección OSINT \\
dato\_recolectado & 54 & Recolección OSINT \\
comentario & 61 & Recolección OSINT \\
dato\_procesado & 49 & ETL / Procesamiento \\
analisis\_sentimiento & 69 & IA — Sentimiento \\
analisis\_comentario & 57 & IA — Sentimiento \\
clasificacion\_tematica & 53 & NLP / ML \\
nlp\_keywords & 50 & NLP / ML \\
nlp\_topicos & 6 & NLP / ML \\
nlp\_clusters & 6 & NLP / ML \\
nlp\_entidades & 15 & NLP / ML \\
nlp\_resumen\_ejecutivo & 1 & NLP / ML \\
osint\_noticias & 40 & Inteligencia OSINT \\
osint\_tendencias & 24 & Inteligencia OSINT \\
osint\_fuente\_resumen & 4 & Inteligencia OSINT \\
patron\_identificado & 10 & Inteligencia OSINT \\
usuario & 4 & Seguridad \\
log\_actividad & 7 & Seguridad \\
alerta & 9 & Alertas \\
configuracion\_alerta & 4 & Alertas \\
evaluacion\_sistema & 22 & Evaluación \\
log\_ejecucion & 28 & Auditoría \\
\midrule
\textbf{Total} & \textbf{576} & \textbf{23 tablas} \\
\bottomrule
\end{tabularx}
